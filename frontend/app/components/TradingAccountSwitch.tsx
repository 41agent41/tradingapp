    ...
    <div className={`bg-white rounded-lg shadow-sm border p-4 sm:p-6 ${className}`}>
      <div className="flex flex-col lg:flex-row lg:items-center justify-between space-y-4 lg:space-y-0">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs sm:text-sm text-gray-600 mb-4">
            Switch between live trading and paper trading modes. This affects all market data
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
            ...
            >
              <div
                className={`w-3 h-3 rounded-full ${isLiveTrading ? 'bg-red-500' : 'bg-gray-400'}`}
              ></div>
      ...
      <div className="mt-4 p-4 rounded-lg border-l-4 bg-blue-50 border-blue-400">
        <div className="flex items-start space-x-3">
          <div className="text-blue-600 text-lg">{isLiveTrading ? '⚠️' : '📊'}</div>
          <div className="flex-1">
            ...
            <div className="text-sm text-blue-700 space-y-1">
              {isLiveTrading ? (
                <>
                  <p>
                    • <strong>Real-time market data</strong> with live pricing
                  </p>
                  <p>
                    • <strong>Live account data</strong> with actual positions and orders
                  </p>
                  <p>
                    • <strong>Real money transactions</strong> - use with caution
                  </p>
                  <p>
                    • <strong>Immediate execution</strong> of trades
                  </p>
                </>
              ) : (
                <>
                  <p>
                    • <strong>Delayed market data</strong> (15-20 minute delay)
                  </p>
                  <p>
                    • <strong>Paper account data</strong> with simulated positions
                  </p>
                  <p>
                    • <strong>Risk-free trading</strong> with virtual money
                  </p>
                  <p>
                    • <strong>Practice environment</strong> for strategy testing
                  </p>
                </>
              )}
            </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-red-700">
                You are now in <strong>LIVE TRADING MODE</strong>. All trades and data requests will
                use real money and live market data. Ensure you understand the risks before
                proceeding.
              </p>
            </div>
          </div>
