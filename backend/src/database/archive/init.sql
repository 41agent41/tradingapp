-- TradingApp Database Initialization Script
-- Run this script against your external PostgreSQL database to set up the schema

-- Connect to the database (run this manually if needed)
-- \c tradingapp;
...
AND table_name IN ('contracts', 'candlestick_data', 'technical_indicators', 'data_collection_sessions', 'data_quality_metrics', 'data_collection_config')
ORDER BY table_name;
...
AND tablename IN ('contracts', 'candlestick_data', 'technical_indicators', 'data_collection_sessions', 'data_quality_metrics', 'data_collection_config')
...
DO $$
BEGIN
    RAISE NOTICE 'TradingApp database schema initialization completed successfully!';
    RAISE NOTICE 'Tables created: contracts, candlestick_data, tick_data, technical_indicators, data_collection_sessions, data_quality_metrics, data_collection_config';
    RAISE NOTICE 'Views created: latest_candlestick_data';
